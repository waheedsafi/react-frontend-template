...
import NastranCard, { type ModelSize } from "./NastranCard";
        ...
        <ModelContextProvider modelOnRequestHide={buttonOnClick}>
          {createPortal(
            <div
              ...
              className={cn(
                "fixed z-50 grid grid-cols-1 justify-items-center items-center overflow-y-auto left-0 top-0 h-screen w-screen [backdrop-filter:blur(10px)]",
                className
              )}
            >
