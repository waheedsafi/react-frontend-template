...
export interface AnimatedUserIconProps {
  style?: {
    firstPathClassName?: string;
    secondPathClassName?: string;
  };
}
export default function AnimatedUserIcon(style?: {
  firstPathClassName?: string;
  secondPathClassName?: string;
}) {
  const { firstPathClassName, secondPathClassName } = style ?? {};
  return (
    <svg
    ...
    >
      <AnimatedPath
		...
		C10.55,10.466,10.767,10.691,10.898,10.787z"
        stroke="#fafafa"
        strokeWidth={1}
        duration={2000}
        fill="none"
      ...
      <AnimatedPath
        ...
        d="M25.876,19.226c-0.645-1.43-4.577-2.669-4.577-2.669
            c-2.095-0.738-2.109-1.476-2.109-1.476
            c-4.121,8.125-7.253,0.022-7.253,0.022
            c-0.286,1.097-4.525,2.381-4.525,2.381
            c-1.24,0.478-1.765,1.192-1.765,1.192
            c-1.834,2.719-2.049,8.769-2.049,8.769
            c0.024,1.383,0.618,1.525,0.618,1.525
            c4.218,1.882,10.831,2.215,10.831,2.215
            c6.792,0.144,11.733-1.929,11.733-1.929
            c0.718-0.454,0.738-0.812,0.738-0.812
            C28.019,24.108,25.876,19.226,25.876,19.226z
